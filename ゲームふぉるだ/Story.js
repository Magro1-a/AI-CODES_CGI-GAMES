(function(){
  ...
  // 物語データ
  // ---------------------------------------------------------------------
  // unlock.type の種類（今回はダミー実装。今後シーザー暗号／ルーン→XOR等に
  // 差し替え/追加していく前提でこの形にしてある）
  //   'auto'      : 常に解放済み（第1章など）
  //   'score'     : ゲーム側の国力(score)がしきい値以上で自動解放
  //   'passphrase': ユーザーが文字列を入力して照合する（現時点では平文比較の
  //                 ダミー。将来的にシーザー暗号解読やXOR等に置き換える差込口）
  // =====================================================================
  const STORY = {
    title: '灯火異聞',
